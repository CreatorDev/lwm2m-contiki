/*
  ...
  gengetopt -i cmds/init.cmdline --string-parser --include-getopt --no-handle-error --no-handle-help --no-version --func-name=init_parser --arg-struct-name=init_args --file-name=cmds/init-cmdline 
...
const char *init_args_purpose = "";

const char *init_args_usage = "Usage: init [OPTIONS]...";

const char *init_args_versiontext = "";

const char *init_args_description = "";

const char *init_args_help[] = {
  "  -h, --help              Print help and exit",
  "  -v, --verbose           Increase program verbosity  (default=off)",
  "  -c, --clientID=STRING   Client ID  (default=`Imgtec')",
  "  -b, --bootstrap=STRING  Bootstrap server\n                            (default=`coap://[2001:1418:100::1]:15683/')",
  "  -p, --port=INT          CoAP Port  (default=`5683')",
    0
};
...
typedef enum {ARG_NO
  ...
  , ARG_STRING
  , ARG_INT
} init_parser_arg_type;

static
void clear_given (struct init_args *args_info);
static
void clear_args (struct init_args *args_info);

static int
init_parser_internal (int argc, char **argv, struct init_args *args_info,
                        struct init_parser_params *params, const char *additional_error);
...
void clear_args (struct init_args *args_info)
{
  ...
  args_info->clientID_arg = gengetopt_strdup ("Imgtec");
  args_info->clientID_orig = NULL;
  args_info->bootstrap_arg = gengetopt_strdup ("coap://[2001:1418:100::1]:15683/");
  args_info->bootstrap_orig = NULL;
  args_info->port_arg = 5683;
  args_info->port_orig = NULL;
  
}

static
void init_args_info(struct init_args *args_info)
{


  args_info->help_help = init_args_help[0] ;
  args_info->verbose_help = init_args_help[1] ;
  args_info->clientID_help = init_args_help[2] ;
  args_info->bootstrap_help = init_args_help[3] ;
  args_info->port_help = init_args_help[4] ;
  
}

void
init_parser_print_version (void)
{
  printf ("%s %s\n",
     (strlen(INIT_PARSER_PACKAGE_NAME) ? INIT_PARSER_PACKAGE_NAME : INIT_PARSER_PACKAGE),
     INIT_PARSER_VERSION);

  if (strlen(init_args_versiontext) > 0)
    printf("\n%s\n", init_args_versiontext);
}

static void print_help_common(void) {
  init_parser_print_version ();

  if (strlen(init_args_purpose) > 0)
    printf("\n%s\n", init_args_purpose);

  if (strlen(init_args_usage) > 0)
    printf("\n%s\n", init_args_usage);

  printf("\n");

  if (strlen(init_args_description) > 0)
    printf("%s\n\n", init_args_description);
}

void
init_parser_print_help (void)
{
  int i = 0;
  print_help_common();
  while (init_args_help[i])
    printf("%s\n", init_args_help[i++]);
}

void
init_parser_init (struct init_args *args_info)
{
...
void
init_parser_params_init(struct init_parser_params *params)
{
  if (params)
    { 
      params->override = 0;
...
init_parser_params_create(void)
{
  struct init_parser_params *params = 
    (struct init_parser_params *)malloc(sizeof(struct init_parser_params));
  init_parser_params_init(params);  
  return params;
}
...
static void
init_parser_release (struct init_args *args_info)
{

  free_string_field (&(args_info->clientID_arg));
  free_string_field (&(args_info->clientID_orig));
  free_string_field (&(args_info->bootstrap_arg));
...
int
init_parser_dump(FILE *outfile, struct init_args *args_info)
{
  int i = 0;
...
int
init_parser_file_save(const char *filename, struct init_args *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  if (!outfile)
    {
      fprintf (stderr, "%s: cannot open file for writing: %s\n", INIT_PARSER_PACKAGE, filename);
      return EXIT_FAILURE;
    }

  i = init_parser_dump(outfile, args_info);
  fclose (outfile);
...
void
init_parser_free (struct init_args *args_info)
{
  init_parser_release (args_info);
}
...
int
init_parser (int argc, char **argv, struct init_args *args_info)
{
  return init_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
init_parser_ext (int argc, char **argv, struct init_args *args_info,
                   struct init_parser_params *params)
{
  int result;
  result = init_parser_internal (argc, argv, args_info, params, 0);

  return result;
}

int
init_parser2 (int argc, char **argv, struct init_args *args_info, int override, int initialize, int check_required)
{
  int result;
  struct init_parser_params params;
...
int
init_parser_required (struct init_args *args_info, const char *prog_name)
{
  FIX_UNUSED (args_info);
 ...
 * @param check_ambiguity @see init_parser_params.check_ambiguity
 * @param override @see init_parser_params.override
...
init_parser_internal (
  int argc, char **argv, struct init_args *args_info,
                        struct init_parser_params *params, const char *additional_error)
{
  int c;	/* Character of the parsed option.  */

  int error_occurred = 0;
  struct init_args local_args_info;
  ...
  if (initialize)
    init_parser_init (args_info);

  init_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hvc:b:p:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          ...
          if (update_arg( 0 , 
              ...
              additional_error))
            goto failure;
          init_parser_free (&local_args_info);
          return 0;
        ...
        case 'c':	/* Client ID.  */
          ...
          if (update_arg( (void *)&(args_info->clientID_arg), 
               &(args_info->clientID_orig), &(args_info->clientID_given),
              &(local_args_info.clientID_given), optarg, 0, "Imgtec", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "clientID", 'c',
              additional_error))
            goto failure;
          ...
          break;
        case 'b':	/* Bootstrap server.  */
        
        
          if (update_arg( (void *)&(args_info->bootstrap_arg), 
               &(args_info->bootstrap_orig), &(args_info->bootstrap_given),
              &(local_args_info.bootstrap_given), optarg, 0, "coap://[2001:1418:100::1]:15683/", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "bootstrap", 'b',
              additional_error))
            goto failure;
        ...
        case 'p':	/* CoAP Port.  */
          ...
          if (update_arg( (void *)&(args_info->port_arg), 
              ...
              &(local_args_info.port_given), optarg, 0, "5683", ARG_INT,
              check_ambiguity, override, 0, 0,
              "port", 'p',
              additional_error))
            goto failure;
        ...
        default:	/* bug: option not considered.  */
          fprintf (stderr, "%s: option unknown: %c%s\n", INIT_PARSER_PACKAGE, c, (additional_error ? additional_error : ""));
          abort ();
        } /* switch */
    } /* while */
  ...
  init_parser_release (&local_args_info);
...
static unsigned int
init_parser_create_argv(const char *cmdline_, char ***argv_ptr, const char *prog_name)
{
  char *cmdline, *p;
  size_t n = 0, j;
  int i;
...
int
init_parser_string(const char *cmdline, struct init_args *args_info, const char *prog_name)
{
  return init_parser_string2(cmdline, args_info, prog_name, 0, 1, 1);
}

int
init_parser_string2(const char *cmdline, struct init_args *args_info, const char *prog_name,
    int override, int initialize, int check_required)
{
  ...
  return init_parser_string_ext(cmdline, args_info, prog_name, &params);
}

int
init_parser_string_ext(const char *cmdline, struct init_args *args_info, const char *prog_name,
    struct init_parser_params *params)
{
  char **argv_ptr = 0;
  int result;
  ...
  argc = init_parser_create_argv(cmdline, &argv_ptr, prog_name);
  
  result =
    init_parser_internal (argc, argv_ptr, args_info, params, 0);
