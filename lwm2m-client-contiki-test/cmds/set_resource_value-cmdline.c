/*
  ...
  gengetopt -i cmds/set_resource_value.cmdline --string-parser --include-getopt --no-handle-error --no-handle-help --no-version --func-name=set_resource_value_parser --arg-struct-name=set_resource_value_args --file-name=cmds/set_resource_value-cmdline 
...
const char *set_resource_value_args_purpose = "";

const char *set_resource_value_args_usage = "Usage: set_resource_value [OPTIONS]...";

const char *set_resource_value_args_versiontext = "";

const char *set_resource_value_args_description = "";

const char *set_resource_value_args_help[] = {
  ...
  "  -v, --value=STRING            Resource Value (base64 encoded)",
    0
};
...
typedef enum {ARG_NO
  , ARG_STRING
  , ARG_INT
} set_resource_value_parser_arg_type;

static
void clear_given (struct set_resource_value_args *args_info);
static
void clear_args (struct set_resource_value_args *args_info);

static int
set_resource_value_parser_internal (int argc, char **argv, struct set_resource_value_args *args_info,
                        struct set_resource_value_parser_params *params, const char *additional_error);

static int
set_resource_value_parser_required2 (struct set_resource_value_args *args_info, const char *prog_name, const char *additional_error);
struct line_list
{
  char * string_arg;
...
static
void init_args_info(struct set_resource_value_args *args_info)
{


  args_info->help_help = set_resource_value_args_help[0] ;
  args_info->objectID_help = set_resource_value_args_help[1] ;
  args_info->objectInstanceID_help = set_resource_value_args_help[2] ;
  args_info->resourceID_help = set_resource_value_args_help[3] ;
  args_info->resourceInstanceID_help = set_resource_value_args_help[4] ;
  args_info->value_help = set_resource_value_args_help[5] ;
  
}

void
set_resource_value_parser_print_version (void)
{
  printf ("%s %s\n",
     (strlen(SET_RESOURCE_VALUE_PARSER_PACKAGE_NAME) ? SET_RESOURCE_VALUE_PARSER_PACKAGE_NAME : SET_RESOURCE_VALUE_PARSER_PACKAGE),
     SET_RESOURCE_VALUE_PARSER_VERSION);

  if (strlen(set_resource_value_args_versiontext) > 0)
    printf("\n%s\n", set_resource_value_args_versiontext);
}

static void print_help_common(void) {
  set_resource_value_parser_print_version ();

  if (strlen(set_resource_value_args_purpose) > 0)
    printf("\n%s\n", set_resource_value_args_purpose);

  if (strlen(set_resource_value_args_usage) > 0)
    printf("\n%s\n", set_resource_value_args_usage);

  printf("\n");

  if (strlen(set_resource_value_args_description) > 0)
    printf("%s\n\n", set_resource_value_args_description);
}

void
set_resource_value_parser_print_help (void)
{
  int i = 0;
  print_help_common();
  while (set_resource_value_args_help[i])
    printf("%s\n", set_resource_value_args_help[i++]);
}

void
set_resource_value_parser_init (struct set_resource_value_args *args_info)
{
...
void
set_resource_value_parser_params_init(struct set_resource_value_parser_params *params)
{
  if (params)
    { 
      params->override = 0;
...
set_resource_value_parser_params_create(void)
{
  struct set_resource_value_parser_params *params = 
    (struct set_resource_value_parser_params *)malloc(sizeof(struct set_resource_value_parser_params));
  set_resource_value_parser_params_init(params);  
  return params;
}
...
static void
set_resource_value_parser_release (struct set_resource_value_args *args_info)
{
...
int
set_resource_value_parser_dump(FILE *outfile, struct set_resource_value_args *args_info)
{
  int i = 0;

  if (!outfile)
    {
      fprintf (stderr, "%s: cannot dump options to stream\n", SET_RESOURCE_VALUE_PARSER_PACKAGE);
      return EXIT_FAILURE;
    }
...
int
set_resource_value_parser_file_save(const char *filename, struct set_resource_value_args *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  if (!outfile)
    {
      fprintf (stderr, "%s: cannot open file for writing: %s\n", SET_RESOURCE_VALUE_PARSER_PACKAGE, filename);
      return EXIT_FAILURE;
    }

  i = set_resource_value_parser_dump(outfile, args_info);
  fclose (outfile);
...
void
set_resource_value_parser_free (struct set_resource_value_args *args_info)
{
  set_resource_value_parser_release (args_info);
}
...
int
set_resource_value_parser (int argc, char **argv, struct set_resource_value_args *args_info)
{
  return set_resource_value_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
set_resource_value_parser_ext (int argc, char **argv, struct set_resource_value_args *args_info,
                   struct set_resource_value_parser_params *params)
{
  int result;
  result = set_resource_value_parser_internal (argc, argv, args_info, params, 0);

  return result;
}

int
set_resource_value_parser2 (int argc, char **argv, struct set_resource_value_args *args_info, int override, int initialize, int check_required)
{
  int result;
  struct set_resource_value_parser_params params;
...
int
set_resource_value_parser_required (struct set_resource_value_args *args_info, const char *prog_name)
{
  int result = EXIT_SUCCESS;

  if (set_resource_value_parser_required2(args_info, prog_name, 0) > 0)
    result = EXIT_FAILURE;
 ...
 * @param check_ambiguity @see set_resource_value_parser_params.check_ambiguity
 * @param override @see set_resource_value_parser_params.override
...
int update_arg(void *field, char **orig_field,
               ...
               set_resource_value_parser_arg_type arg_type,
...
int
set_resource_value_parser_internal (
  int argc, char **argv, struct set_resource_value_args *args_info,
                        struct set_resource_value_parser_params *params, const char *additional_error)
{
  int c;	/* Character of the parsed option.  */

  int error_occurred = 0;
  struct set_resource_value_args local_args_info;
  ...
  if (initialize)
    set_resource_value_parser_init (args_info);

  set_resource_value_parser_init (&local_args_info);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "ho:i:r:n:v:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'h':	/* Print help and exit.  */
          ...
          if (update_arg( 0 , 
              ...
              additional_error))
            goto failure;
          set_resource_value_parser_free (&local_args_info);
          return 0;
        ...
        case 'n':	/* Resource Instance ID.  */
          ...
          break;
        case 'v':	/* Resource Value (base64 encoded).  */
        ...
        default:	/* bug: option not considered.  */
          fprintf (stderr, "%s: option unknown: %c%s\n", SET_RESOURCE_VALUE_PARSER_PACKAGE, c, (additional_error ? additional_error : ""));
          abort ();
        } /* switch */
    } /* while */
  ...
  if (check_required)
    {
      error_occurred += set_resource_value_parser_required2 (args_info, argv[0], additional_error);
    }

  set_resource_value_parser_release (&local_args_info);
...
static unsigned int
set_resource_value_parser_create_argv(const char *cmdline_, char ***argv_ptr, const char *prog_name)
{
  char *cmdline, *p;
  size_t n = 0, j;
  int i;
...
int
set_resource_value_parser_string(const char *cmdline, struct set_resource_value_args *args_info, const char *prog_name)
{
  return set_resource_value_parser_string2(cmdline, args_info, prog_name, 0, 1, 1);
}

int
set_resource_value_parser_string2(const char *cmdline, struct set_resource_value_args *args_info, const char *prog_name,
    int override, int initialize, int check_required)
{
  ...
  return set_resource_value_parser_string_ext(cmdline, args_info, prog_name, &params);
}

int
set_resource_value_parser_string_ext(const char *cmdline, struct set_resource_value_args *args_info, const char *prog_name,
    struct set_resource_value_parser_params *params)
{
  char **argv_ptr = 0;
  int result;
  ...
  argc = set_resource_value_parser_create_argv(cmdline, &argv_ptr, prog_name);
  
  result =
    set_resource_value_parser_internal (argc, argv_ptr, args_info, params, 0);
